...
namespace Benjathemaker
{
    public class SimpleGemsAnim : MonoBehaviour
    {
        ...
        public float rotationSpeed = 85f; // Degrees per second

        public bool isFloating = true;
        public bool useEasingForFloating = true; // Separate toggle for floating ease
        public float floatHeight = 0.4f; // Max height displacement
        ...
        public bool useEasingForScaling = true; // Separate toggle for scaling ease
